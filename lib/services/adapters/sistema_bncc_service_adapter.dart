...
class SistemaBnccServiceAdapter {
  Future<void> salvar(List<dynamic> sistema_bncc) async {
    Box sistema_bnccBox = Hive.box('sistema_bncc');

    sistema_bnccBox.put('sistema_bncc', sistema_bncc);

    List<dynamic> sistema_bnccSalvos = sistema_bnccBox.get('sistema_bncc');
